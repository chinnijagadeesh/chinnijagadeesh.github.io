...
const Navbar = () => {
  ...
  const { newTheme, mode, handleMode, open, handleMenu } = useContext(
    ThemeContext
  );
      ...
      <div className={styles.navbar}>
        <a href="#home">
          <div className={styles.logo}>
            <img src="https://tse3.mm.bing.net/th?id=OIP.RW0ivZrnStt8_OwVSHYXawHaHa&pid=Api&P=0" alt="Logo" />
          </div>
        </a>
        ...
        <div style={{ color: `${newTheme.title}` }} className={styles.links}>
          ...
          <a href="#experience">Statistics</a>
