    ...
    >
      <div className={styles.container}>
        ...
        >
          ...
          <a
            href="mailto: jagadeeshyadav7551@gmail.com"
            aria-label="email"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://twitter.com/chinnijagadees8"
            aria-label="Twitter"
            target="_blank"
            rel="noreferrer"
          >
          ...
          <a
            href="https://github.com/chinnijagadeesh"
            aria-label="GitHub"
            rel="noreferrer"
            target="_blank"
          >
          ...
          <a
            href="https://www.linkedin.com/in/chinni-jagadeesh-663090228/"
            aria-label="Linkedin"
            target="_blank"
            rel="noreferrer"
          >
